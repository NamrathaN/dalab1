...
with(faculty, boxplot(as.numeric(Designation), Papers.Published,
              main = "Designation vs Papers Published",
              xlab = "Designation",
              ylab = "Papers Published ",col=2))


with(faculty, barplot(as.numeric(Designation), Training,
              main = "Designation vs Trainings",
              xlab = "Designation",
              ylab = "Tranings",col=3))
with(faculty, barplot(as.numeric(Designation), Papers.Published,
              main = "Designation vs Papers Published",
              xlab = "Designation",
